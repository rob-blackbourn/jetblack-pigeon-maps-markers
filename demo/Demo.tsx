...
import { Point, Map, Draggable, ZoomControl } from 'pigeon-maps'
import {
  Marker,
  SVGAdornment,
  SVGMarker,
...
const reims: Point = [49.26548933836353, 4.033912841490408]
...
export function Demo(): JSX.Element {
  ...
  const handlePolyLineClick = ({ payload, point }: SVGPolyLineEvent) => {
    console.log(`Marker #${payload} clicked at: `, point)
  }
    ...
    <div style={{ textAlign: 'center', marginTop: 50 }}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        ...
        >
          ...
          <SVGAdornment
            render={(props: SVGMarkerProps) => (
              <SVGMarker {...props} onClick={handleMarkerClick} payload="Reims" anchor={reims} width={39} />
            )}
          />

          <SVGAdornment
            render={(props: SVGPolyLineProps) => (
              <SVGPolyLine
                {...props}
                strokeWidth={4}
                coordinates={[markers.coast[0], markers.ghent[0], markers.brussels[0], markers.leuven1[0]]}
                payload="Path from coast to Leuven"
